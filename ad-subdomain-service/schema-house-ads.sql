...
ALTER TABLE ad_banners ADD COLUMN IF NOT EXISTS is_house TINYINT(1) NOT NULL DEFAULT 0;
ALTER TABLE video_ads ADD COLUMN IF NOT EXISTS is_house TINYINT(1) NOT NULL DEFAULT 0;
